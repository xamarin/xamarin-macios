...
class EnumEmitter (ISymbolBindingContext<EnumDeclarationSyntax> context, TabbedStringBuilder builder)
	...
	public IEnumerable<string> UsingStatements => ["System", "ObjCRuntime"];
	...
	bool TryEmit (TabbedStringBuilder classBlock, ImmutableArray<(IFieldSymbol Symbol, FieldData FieldData)> fields)
	{
