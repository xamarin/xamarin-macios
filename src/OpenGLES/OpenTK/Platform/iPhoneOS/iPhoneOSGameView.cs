    ...
    sealed class GLCalls {
        ...
        static GLCalls CreateES1()
        {
            return new GLCalls() {
                ...
                GetRenderbufferParameter= (All t, All p, out int a) => 
                {
                    a = 0;
                    ES11.GL.Oes.GetRenderbufferParameter (t, p, ref a);
                },
        ...
        static GLCalls CreateES2()
        {
            return new GLCalls() {
                ...
                {
                    a = 0;
                    ES20.GL.GetRenderbufferParameter ((ES20.All) t, (ES20.All) p, ref a);
                },
