...
namespace Intents {
	...
	interface INCallRecord : NSCopying, NSSecureCoding {
		...
		[Deprecated (PlatformName.WatchOS, 7, 3, message: "Use '.ctor (string, NSDate, INCallRecordType, INCallCapability, double?, bool?, int?)' instead.")]
		...
		[Deprecated (PlatformName.WatchOS, 7, 3, message: "Use '.ctor (string, NSDate, INCallRecordType, INCallCapability, double?, bool?)' instead.")]
		...
		[Deprecated (PlatformName.WatchOS, 7, 3)]
