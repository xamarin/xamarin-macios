...
namespace MetalPerformanceShadersGraph
{
	...
	interface MPSGraph_MPSGraphActivationOps
	{
		...
		MPSGraphTensor ReLUWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ReLUGradientWithIncomingGradient (MPSGraphTensor gradient, MPSGraphTensor source, [NullAllowed] string name);
		...
		MPSGraphTensor SigmoidWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SigmoidGradientWithIncomingGradient (MPSGraphTensor gradient, MPSGraphTensor source, [NullAllowed] string name);
		...
		MPSGraphTensor SoftMaxWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor SoftMaxGradientWithIncomingGradient (MPSGraphTensor gradient, MPSGraphTensor source, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor LeakyReLUWithTensor (MPSGraphTensor tensor, double alpha, [NullAllowed] string name);
		...
		MPSGraphTensor LeakyReLUWithTensor (MPSGraphTensor tensor, MPSGraphTensor alphaTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LeakyReLUGradientWithIncomingGradient (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphTensor alphaTensor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphArithmeticOps
	{
		...
		MPSGraphTensor IdentityWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ExponentWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ExponentBase2WithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ExponentBase10WithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogarithmWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogarithmBase2WithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogarithmBase10WithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SquareWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SquareRootWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ReverseSquareRootWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ReciprocalWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AbsoluteWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor NegativeWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SignWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SignbitWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor CeilWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor FloorWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor RoundWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor RintWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SinWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor CosWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor TanWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor SinhWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor CoshWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor TanhWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AsinWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AcosWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AtanWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AsinhWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AcoshWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AtanhWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor NotWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor IsInfiniteWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor IsFiniteWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor IsNaNWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor ErfWithTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor AdditionWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor SubtractionWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor MultiplicationWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor DivisionWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor ModuloWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor PowerWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor MinimumWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor MaximumWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor MinimumWithNaNPropagationWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor MaximumWithNaNPropagationWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor EqualWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor NotEqualWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LessThanWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LessThanOrEqualToWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor GreaterThanWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor GreaterThanOrEqualToWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalANDWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalORWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalNANDWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalNORWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalXORWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor LogicalXNORWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor Atan2WithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor SelectWithPredicateTensor (MPSGraphTensor predicateTensor, MPSGraphTensor truePredicateTensor, MPSGraphTensor falseSelectTensor, [NullAllowed] string name);
		...
		MPSGraphTensor ClampWithTensor (MPSGraphTensor tensor, MPSGraphTensor minValueTensor, MPSGraphTensor maxValueTensor, [NullAllowed] string name);
		...
		MPSGraphTensor DivisionNoNaNWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
		...
		MPSGraphTensor FloorModuloWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
	}
	...
	interface MPSGraphConvolution2DOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphConvolution2DOpDescriptor DescriptorWithStrideInX (nuint strideInX, nuint strideInY, nuint dilationRateInX, nuint dilationRateInY, nuint groups, nuint paddingLeft, nuint paddingRight, nuint paddingTop, nuint paddingBottom, MPSGraphPaddingStyle paddingStyle, MPSGraphTensorNamedDataLayout dataLayout, MPSGraphTensorNamedDataLayout weightsLayout);
		...
		[return: NullAllowed]
		MPSGraphConvolution2DOpDescriptor DescriptorWithStrideInX (nuint strideInX, nuint strideInY, nuint dilationRateInX, nuint dilationRateInY, nuint groups, MPSGraphPaddingStyle paddingStyle, MPSGraphTensorNamedDataLayout dataLayout, MPSGraphTensorNamedDataLayout weightsLayout);
		...
		void SetExplicitPaddingWithPaddingLeft (nuint paddingLeft, nuint paddingRight, nuint paddingTop, nuint paddingBottom);
	}
	...
	interface MPSGraph_MPSGraphConvolutionOps
	{
		...
		MPSGraphTensor Convolution2DWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, MPSGraphConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor Convolution2DDataGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor weights, NSNumber[] outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor Convolution2DDataGradientWithIncomingGradientTensor (MPSGraphTensor gradient, MPSGraphTensor weights, MPSGraphTensor outputShapeTensor, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor Convolution2DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor source, NSNumber[] outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor Convolution2DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphTensor outputShapeTensor, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphConvolutionTransposeOps
	{
		...
		MPSGraphTensor ConvolutionTranspose2DWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, NSNumber[] outputShape, MPSGraphConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor ConvolutionTranspose2DWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, MPSGraphTensor outputShape, MPSGraphConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor ConvolutionTranspose2DDataGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor weights, NSNumber[] outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor ConvolutionTranspose2DDataGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor weights, MPSGraphTensor outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor ConvolutionTranspose2DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor source, NSNumber[] outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
		...
		MPSGraphTensor ConvolutionTranspose2DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor source, MPSGraphTensor outputShape, MPSGraphConvolution2DOpDescriptor forwardConvolutionDescriptor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphControlFlowOps
	{
		...
		MPSGraphTensor[] ControlDependencyWithOperations (MPSGraphOperation[] operations, MPSGraphControlFlowDependencyBlock dependentBlock, [NullAllowed] string name);
		...
		MPSGraphTensor[] IfWithPredicateTensor (MPSGraphTensor predicateTensor, MPSGraphIfThenElseBlock thenBlock, [NullAllowed] MPSGraphIfThenElseBlock elseBlock, [NullAllowed] string name);
		...
		MPSGraphTensor[] WhileWithInitialInputs (MPSGraphTensor[] initialInputs, MPSGraphWhileBeforeBlock before, MPSGraphWhileAfterBlock after, [NullAllowed] string name);
		...
		MPSGraphTensor[] ForLoopWithLowerBound (MPSGraphTensor lowerBound, MPSGraphTensor upperBound, MPSGraphTensor step, MPSGraphTensor[] initialBodyArguments, MPSGraphForLoopBodyBlock body, [NullAllowed] string name);
		...
		MPSGraphTensor[] ForLoopWithNumberOfIterations (MPSGraphTensor numberOfIterations, MPSGraphTensor[] initialBodyArguments, MPSGraphForLoopBodyBlock body, [NullAllowed] string name);
	}
	...
	interface MPSGraphDepthwiseConvolution2DOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphDepthwiseConvolution2DOpDescriptor DescriptorWithStrideInX (nuint strideInX, nuint strideInY, nuint dilationRateInX, nuint dilationRateInY, nuint paddingLeft, nuint paddingRight, nuint paddingTop, nuint paddingBottom, MPSGraphPaddingStyle paddingStyle, MPSGraphTensorNamedDataLayout dataLayout, MPSGraphTensorNamedDataLayout weightsLayout);
		...
		[return: NullAllowed]
		MPSGraphDepthwiseConvolution2DOpDescriptor DescriptorWithDataLayout (MPSGraphTensorNamedDataLayout dataLayout, MPSGraphTensorNamedDataLayout weightsLayout);
	...
	interface MPSGraphDepthwiseConvolution3DOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphDepthwiseConvolution3DOpDescriptor DescriptorWithStrides (NSNumber[] strides, NSNumber[] dilationRates, NSNumber[] paddingValues, MPSGraphPaddingStyle paddingStyle);
	...
	interface MPSGraph_MPSGraphDepthwiseConvolutionOps
	{
		...
		MPSGraphTensor DepthwiseConvolution2DWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, MPSGraphDepthwiseConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor DepthwiseConvolution2DDataGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor weights, NSNumber[] outputShape, MPSGraphDepthwiseConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor DepthwiseConvolution2DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor source, NSNumber[] outputShape, MPSGraphDepthwiseConvolution2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor DepthwiseConvolution3DWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, MPSGraphDepthwiseConvolution3DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor DepthwiseConvolution3DDataGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor weights, [NullAllowed] NSNumber[] outputShape, MPSGraphDepthwiseConvolution3DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor DepthwiseConvolution3DWeightsGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradient, MPSGraphTensor source, NSNumber[] outputShape, MPSGraphDepthwiseConvolution3DOpDescriptor descriptor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_GatherNDOps
	{
		...
		MPSGraphTensor GatherNDWithUpdatesTensor (MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nuint batchDimensions, [NullAllowed] string name);
	}
	...
	interface MPSGraph_GatherOps
	{
		...
		MPSGraphTensor GatherWithUpdatesTensor (MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nuint axis, nuint batchDimensions, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphLossOps
	{
		...
		MPSGraphTensor SoftMaxCrossEntropyWithSourceTensor (MPSGraphTensor sourceTensor, MPSGraphTensor labelsTensor, nint axis, MPSGraphLossReductionType reductionType, [NullAllowed] string name);
		...
		MPSGraphTensor SoftMaxCrossEntropyGradientWithIncomingGradientTensor (MPSGraphTensor gradientTensor, MPSGraphTensor sourceTensor, MPSGraphTensor labelsTensor, nint axis, MPSGraphLossReductionType reductionType, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphMatrixMultiplicationOps
	{
		...
		MPSGraphTensor MatrixMultiplicationWithPrimaryTensor (MPSGraphTensor primaryTensor, MPSGraphTensor secondaryTensor, [NullAllowed] string name);
	}
	...
	interface MPSGraphCreateSparseOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphCreateSparseOpDescriptor DescriptorWithStorageType (MPSGraphSparseStorageType sparseStorageType, MPSDataType dataType);
	}
	...
	interface MPSGraph_MPSGraphSparseOps
	{
		...
		MPSGraphTensor SparseTensorWithType (MPSGraphSparseStorageType sparseStorageType, MPSGraphTensor[] inputTensorArray, NSNumber[] shape, MPSDataType dataType, [NullAllowed] string name);
		...
		MPSGraphTensor SparseTensorWithDescriptor (MPSGraphCreateSparseOpDescriptor sparseDescriptor, MPSGraphTensor[] inputTensorArray, NSNumber[] shape, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MemoryOps
	{
		...
		MPSGraphTensor PlaceholderWithShape ([NullAllowed] NSNumber[] shape, MPSDataType dataType, [NullAllowed] string name);
		...
		MPSGraphTensor PlaceholderWithShape ([NullAllowed] NSNumber[] shape, [NullAllowed] string name);
		...
		MPSGraphTensor ConstantWithData (NSData data, NSNumber[] shape, MPSDataType dataType);
		...
		MPSGraphTensor ConstantWithScalar (double scalar, MPSDataType dataType);
		...
		MPSGraphTensor ConstantWithScalar (double scalar, NSNumber[] shape, MPSDataType dataType);
		...
		MPSGraphTensor VariableWithData (NSData data, NSNumber[] shape, MPSDataType dataType, [NullAllowed] string name);
	...
	interface MPSGraph_MPSGraphNormalizationOps
	{
		...
		MPSGraphTensor MeanOfTensor (MPSGraphTensor tensor, NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor VarianceOfTensor (MPSGraphTensor tensor, MPSGraphTensor meanTensor, NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor VarianceOfTensor (MPSGraphTensor tensor, NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor NormalizationWithTensor (MPSGraphTensor tensor, MPSGraphTensor mean, MPSGraphTensor variance, [NullAllowed] MPSGraphTensor gamma, [NullAllowed] MPSGraphTensor beta, float epsilon, [NullAllowed] string name);
		...
		MPSGraphTensor NormalizationGammaGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor sourceTensor, MPSGraphTensor meanTensor, MPSGraphTensor varianceTensor, NSNumber[] axes, float epsilon, [NullAllowed] string name);
		...
		MPSGraphTensor NormalizationBetaGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor sourceTensor, NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor NormalizationGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor sourceTensor, MPSGraphTensor meanTensor, MPSGraphTensor varianceTensor, [NullAllowed] MPSGraphTensor gamma, [NullAllowed] MPSGraphTensor gammaGradient, [NullAllowed] MPSGraphTensor betaGradient, NSNumber[] axes, float epsilon, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphOneHotOps
	{
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, nuint axis, MPSDataType dataType, double onValue, double offValue, [NullAllowed] string name);
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, MPSDataType dataType, double onValue, double offValue, [NullAllowed] string name);
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, nuint axis, MPSDataType dataType, [NullAllowed] string name);
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, nuint axis, [NullAllowed] string name);
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, MPSDataType dataType, [NullAllowed] string name);
		...
		MPSGraphTensor OneHotWithIndicesTensor (MPSGraphTensor indicesTensor, nuint depth, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphOptimizerOps
	{
		...
		MPSGraphTensor StochasticGradientDescentWithLearningRateTensor (MPSGraphTensor learningRateTensor, MPSGraphTensor valuesTensor, MPSGraphTensor gradientTensor, [NullAllowed] string name);
		...
		MPSGraphOperation ApplyStochasticGradientDescentWithLearningRateTensor (MPSGraphTensor learningRateTensor, MPSGraphVariableOp variable, MPSGraphTensor gradientTensor, [NullAllowed] string name);
	}
	...
	interface MPSGraphPooling2DOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphPooling2DOpDescriptor DescriptorWithKernelWidth (nuint kernelWidth, nuint kernelHeight, nuint strideInX, nuint strideInY, MPSGraphPaddingStyle paddingStyle, MPSGraphTensorNamedDataLayout dataLayout);
	...
	interface MPSGraphPooling4DOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphPooling4DOpDescriptor DescriptorWithKernelSizes (NSNumber[] kernelSizes, NSNumber[] strides, NSNumber[] dilationRates, NSNumber[] paddingValues, MPSGraphPaddingStyle paddingStyle);
		...
		[return: NullAllowed]
		MPSGraphPooling4DOpDescriptor DescriptorWithKernelSizes (NSNumber[] kernelSizes, MPSGraphPaddingStyle paddingStyle);
	}
	...
	interface MPSGraph_MPSGraphPoolingOps
	{
		...
		MPSGraphTensor MaxPooling2DWithSourceTensor (MPSGraphTensor source, MPSGraphPooling2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor MaxPooling2DGradientWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphPooling2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor AvgPooling2DWithSourceTensor (MPSGraphTensor source, MPSGraphPooling2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor AvgPooling2DGradientWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphPooling2DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor MaxPooling4DWithSourceTensor (MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor MaxPooling4DGradientWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor AvgPooling4DWithSourceTensor (MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor AvgPooling4DGradientWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor L2NormPooling4DWithSourceTensor (MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor L2NormPooling4DGradientWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphPooling4DOpDescriptor descriptor, [NullAllowed] string name);
	}
	...
	interface MPSGraphRandomOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphRandomOpDescriptor DescriptorWithDistribution (MPSGraphRandomDistribution distribution, MPSDataType dataType);
	}
	...
	interface MPSGraph_MPSGraphRandomOps
	{
		...
		MPSGraphTensor RandomPhiloxStateTensorWithSeed (nuint seed, [NullAllowed] string name);
		...
		MPSGraphTensor RandomPhiloxStateTensorWithCounterLow (nuint counterLow, nuint counterHigh, nuint key, [NullAllowed] string name);
		...
		MPSGraphTensor RandomTensorWithShape (NSNumber[] shape, MPSGraphRandomOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor RandomTensorWithShapeTensor (MPSGraphTensor shapeTensor, MPSGraphRandomOpDescriptor descriptor, [NullAllowed] string name);
		...
		MPSGraphTensor RandomTensorWithShape (NSNumber[] shape, MPSGraphRandomOpDescriptor descriptor, nuint seed, [NullAllowed] string name);
		...
		MPSGraphTensor RandomTensorWithShapeTensor (MPSGraphTensor shapeTensor, MPSGraphRandomOpDescriptor descriptor, nuint seed, [NullAllowed] string name);
		...
		MPSGraphTensor[] RandomTensorWithShape (NSNumber[] shape, MPSGraphRandomOpDescriptor descriptor, MPSGraphTensor state, [NullAllowed] string name);
		...
		MPSGraphTensor[] RandomTensorWithShapeTensor (MPSGraphTensor shapeTensor, MPSGraphRandomOpDescriptor descriptor, MPSGraphTensor state, [NullAllowed] string name);
		...
		MPSGraphTensor RandomUniformTensorWithShape (NSNumber[] shape, [NullAllowed] string name);
		...
		MPSGraphTensor RandomUniformTensorWithShapeTensor (MPSGraphTensor shapeTensor, [NullAllowed] string name);
		...
		MPSGraphTensor RandomUniformTensorWithShape (NSNumber[] shape, nuint seed, [NullAllowed] string name);
		...
		MPSGraphTensor RandomUniformTensorWithShapeTensor (MPSGraphTensor shapeTensor, nuint seed, [NullAllowed] string name);
		...
		MPSGraphTensor[] RandomUniformTensorWithShape (NSNumber[] shape, MPSGraphTensor state, [NullAllowed] string name);
		...
		MPSGraphTensor[] RandomUniformTensorWithShapeTensor (MPSGraphTensor shapeTensor, MPSGraphTensor state, [NullAllowed] string name);
		...
		MPSGraphTensor DropoutTensor (MPSGraphTensor tensor, double rate, [NullAllowed] string name);
		...
		MPSGraphTensor DropoutTensor (MPSGraphTensor tensor, MPSGraphTensor rate, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphReductionOps
	{
		...
		MPSGraphTensor ReductionSumWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionSumWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMaximumWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMaximumWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMinimumWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMinimumWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMaximumPropagateNaNWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMaximumPropagateNaNWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMinimumPropagateNaNWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionMinimumPropagateNaNWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionProductWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionProductWithTensor (MPSGraphTensor tensor, [NullAllowed] NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionArgMaximumWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor ReductionArgMinimumWithTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphResizeOps
	{
		...
		MPSGraphTensor ResizeTensor (MPSGraphTensor imagesTensor, NSNumber[] size, MPSGraphResizeMode mode, bool centerResult, bool alignCorners, MPSGraphTensorNamedDataLayout layout, [NullAllowed] string name);
		...
		MPSGraphTensor ResizeTensor (MPSGraphTensor imagesTensor, MPSGraphTensor size, MPSGraphResizeMode mode, bool centerResult, bool alignCorners, MPSGraphTensorNamedDataLayout layout, [NullAllowed] string name);
		...
		MPSGraphTensor ResizeWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor input, MPSGraphResizeMode mode, bool centerResult, bool alignCorners, MPSGraphTensorNamedDataLayout layout, [NullAllowed] string name);
	}
	...
	interface MPSGraph_ScatterNDOps
	{
		...
		MPSGraphTensor ScatterNDWithUpdatesTensor (MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, NSNumber[] shape, nuint batchDimensions, MPSGraphScatterMode mode, [NullAllowed] string name);
		...
		MPSGraphTensor ScatterNDWithUpdatesTensor (MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, NSNumber[] shape, nuint batchDimensions, [NullAllowed] string name);
		...
		MPSGraphTensor ScatterNDWithDataTensor (MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nuint batchDimensions, MPSGraphScatterMode mode, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphScatterOps
	{
		...
		MPSGraphTensor ScatterWithUpdatesTensor (MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, NSNumber[] shape, nint axis, MPSGraphScatterMode mode, [NullAllowed] string name);
		...
		MPSGraphTensor ScatterWithDataTensor (MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nint axis, MPSGraphScatterMode mode, [NullAllowed] string name);
	}
	...
	interface MPSGraphStencilOpDescriptor : NSCopying
	{
		...
		[return: NullAllowed]
		MPSGraphStencilOpDescriptor DescriptorWithReductionMode (MPSGraphReductionMode reductionMode, NSNumber[] offsets, NSNumber[] strides, NSNumber[] dilationRates, NSNumber[] explicitPadding, MPSGraphPaddingMode boundaryMode, MPSGraphPaddingStyle paddingStyle, float paddingConstant);
		...
		[return: NullAllowed]
		MPSGraphStencilOpDescriptor DescriptorWithOffsets (NSNumber[] offsets, NSNumber[] explicitPadding);
		...
		[return: NullAllowed]
		MPSGraphStencilOpDescriptor DescriptorWithExplicitPadding (NSNumber[] explicitPadding);
	...
	interface MPSGraph_MPSGraphStencilOps
	{
		...
		MPSGraphTensor StencilWithSourceTensor (MPSGraphTensor source, MPSGraphTensor weights, MPSGraphStencilOpDescriptor descriptor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphTensorShapeOps
	{
		...
		MPSGraphTensor ReshapeTensor (MPSGraphTensor tensor, NSNumber[] shape, [NullAllowed] string name);
		...
		MPSGraphTensor ReshapeTensor (MPSGraphTensor tensor, MPSGraphTensor shapeTensor, [NullAllowed] string name);
		...
		MPSGraphTensor TransposeTensor (MPSGraphTensor tensor, nuint dimensionIndex, nuint dimensionIndex2, [NullAllowed] string name);
		...
		MPSGraphTensor SliceTensor (MPSGraphTensor tensor, nuint dimensionIndex, nint start, nint length, [NullAllowed] string name);
		...
		MPSGraphTensor SliceTensor (MPSGraphTensor tensor, NSNumber[] starts, NSNumber[] ends, NSNumber[] strides, [NullAllowed] string name);
		...
		MPSGraphTensor SliceTensor (MPSGraphTensor tensor, NSNumber[] starts, NSNumber[] ends, NSNumber[] strides, uint startMask, uint endMask, uint squeezeMask, [NullAllowed] string name);
		...
		MPSGraphTensor SliceGradientTensor (MPSGraphTensor inputGradientTensor, MPSGraphTensor fwdInShapeTensor, NSNumber[] starts, NSNumber[] ends, NSNumber[] strides, [NullAllowed] string name);
		...
		MPSGraphTensor SliceGradientTensor (MPSGraphTensor inputGradientTensor, MPSGraphTensor fwdInShapeTensor, NSNumber[] starts, NSNumber[] ends, NSNumber[] strides, uint startMask, uint endMask, uint squeezeMask, [NullAllowed] string name);
		...
		MPSGraphTensor ConcatTensor (MPSGraphTensor tensor, MPSGraphTensor tensor2, nint dimensionIndex, [NullAllowed] string name);
		...
		MPSGraphTensor TileTensor (MPSGraphTensor tensor, NSNumber[] multiplier, [NullAllowed] string name);
		...
		MPSGraphTensor TileGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor sourceTensor, NSNumber[] multiplier, [NullAllowed] string name);
		...
		MPSGraphTensor PadTensor (MPSGraphTensor tensor, MPSGraphPaddingMode paddingMode, NSNumber[] leftPadding, NSNumber[] rightPadding, double constantValue, [NullAllowed] string name);
		...
		MPSGraphTensor PadGradientWithIncomingGradientTensor (MPSGraphTensor incomingGradientTensor, MPSGraphTensor sourceTensor, MPSGraphPaddingMode paddingMode, NSNumber[] leftPadding, NSNumber[] rightPadding, [NullAllowed] string name);
		...
		MPSGraphTensor SpaceToDepth2DTensor (MPSGraphTensor tensor, MPSGraphTensor widthAxisTensor, MPSGraphTensor heightAxisTensor, MPSGraphTensor depthAxisTensor, nuint blockSize, bool usePixelShuffleOrder, [NullAllowed] string name);
		...
		MPSGraphTensor DepthToSpace2DTensor (MPSGraphTensor tensor, MPSGraphTensor widthAxisTensor, MPSGraphTensor heightAxisTensor, MPSGraphTensor depthAxisTensor, nuint blockSize, bool usePixelShuffleOrder, [NullAllowed] string name);
		...
		MPSGraphTensor SpaceToDepth2DTensor (MPSGraphTensor tensor, nuint widthAxis, nuint heightAxis, nuint depthAxis, nuint blockSize, bool usePixelShuffleOrder, [NullAllowed] string name);
		...
		MPSGraphTensor DepthToSpace2DTensor (MPSGraphTensor tensor, nuint widthAxis, nuint heightAxis, nuint depthAxis, nuint blockSize, bool usePixelShuffleOrder, [NullAllowed] string name);
		...
		MPSGraphTensor ReverseTensor (MPSGraphTensor tensor, MPSGraphTensor axesTensor, [NullAllowed] string name);
		...
		MPSGraphTensor ReverseTensor (MPSGraphTensor tensor, NSNumber[] axes, [NullAllowed] string name);
		...
		MPSGraphTensor ReverseTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor Flatten2DTensor (MPSGraphTensor tensor, nint axis, [NullAllowed] string name);
		...
		MPSGraphTensor Flatten2DTensor (MPSGraphTensor tensor, MPSGraphTensor axisTensor, [NullAllowed] string name);
		...
		MPSGraphTensor BroadcastTensor (MPSGraphTensor tensor, NSNumber[] shape, [NullAllowed] string name);
		...
		MPSGraphTensor BroadcastTensor (MPSGraphTensor tensor, MPSGraphTensor shapeTensor, [NullAllowed] string name);
		...
		MPSGraphTensor ShapeOfTensor (MPSGraphTensor tensor, [NullAllowed] string name);
		...
		MPSGraphTensor CastTensor (MPSGraphTensor tensor, MPSDataType type, string name);
	}
	...
	interface MPSGraph_MPSGraphTopKOps
	{
		...
		MPSGraphTensor[] TopKWithSourceTensor (MPSGraphTensor source, nuint k, [NullAllowed] string name);
		...
		MPSGraphTensor[] TopKWithSourceTensor (MPSGraphTensor source, MPSGraphTensor kTensor, [NullAllowed] string name);
	}
	...
	interface MPSGraph_MPSGraphTopKGradientOps
	{
		...
		MPSGraphTensor TopKWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, nuint k, [NullAllowed] string name);
		...
		MPSGraphTensor TopKWithGradientTensor (MPSGraphTensor gradient, MPSGraphTensor source, MPSGraphTensor kTensor, [NullAllowed] string name);
	}
