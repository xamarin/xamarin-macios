...
using Matrix4d = global::Simd.Matrix4d;
#else
...
namespace XamCore.ModelIO {
	...
	[iOS (9,0), Mac(10,11, onlyOn64 : true)]
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]// Exposed below as DesignatedInitializer, spoted by xtro
	interface MDLTexture : MDLNamed
	{
		...
		[DesignatedInitializer] // Sppoted by xtro
		[Export ("init")]
		IntPtr Constructor ();
		...
		[return: NullAllowed]
		CGImage GetImageFromTexture (nuint atLevel);
	...
	interface MDLAnimatedVector2 {
		...
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorFloat2 value, double time);

		[Export ("setDouble2:atTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorDouble2 value, double time);

		[Export ("float2AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorFloat2 GetVector2Value (double time);

		[Export ("double2AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorDouble2 GetVector2dValue (double time);
	...
	interface MDLAnimatedVector3 {
		...
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorFloat3 value, double time);

		[Export ("setDouble3:atTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorDouble3 value, double time);

		[Export ("float3AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorFloat3 GetVectorFloat3Value (double time);

		[Export ("double3AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorDouble3 GetVectorDouble3Value (double time);
	...
	interface MDLAnimatedVector4 {
		...
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorFloat4 value, double time);

		[Export ("setDouble4:atTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (VectorDouble4 value, double time);

		[Export ("float4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorFloat4 GetVector4Value (double time);

		[Export ("double4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		VectorDouble4 GetVector4dValue (double time);
	...
	interface MDLAnimatedMatrix4x4 {
		...
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (MatrixFloat4x4 value, double time);

		[Export ("setDouble4x4:atTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		void SetValue (MatrixDouble4x4 value, double time);

		[Export ("float4x4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		MatrixFloat4x4 GetMatrixFloat4x4Value (double time);

		[Export ("double4x4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		MatrixDouble4x4 GetMatrixDouble4x4Value (double time);
	...
	interface MDLAnimationBindComponent : NSCopying, MDLComponent {
		...
		MatrixDouble4x4 GeometryBindTransform { 
			[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
			get;
			[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
			set;
	...
	interface MDLTransformOp {
		...
		[Export ("float4x4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		MatrixFloat4x4 GetMatrixFloat4x4 (double atTime);

		[Abstract]
		[Export ("double4x4AtTime:")]
		[MarshalDirective (NativePrefix = "xamarin_simd__", Library = "__Internal")]
		MatrixDouble4x4 GetMatrixDouble4x4 (double atTime);
