...
namespace XamCore.GameKit {
...
#if TVOS
	// hack to let [NoTV] work properly
	...
	interface GKMatchmakerViewControllerDelegate {
...
#endif
		[NoTV]
		[Availability (Deprecated = Platform.iOS_8_0 | Platform.Mac_10_10, Message = "Use DidFindHostedPlayers")]
		...
		[NoTV]
		[Since (5,0)]
		[Availability (Deprecated = Platform.iOS_8_0 | Platform.Mac_10_10, Message = "Use HostedPlayerDidAccept")]
	...
	interface GKTurnBasedParticipant {
		...
		[NoTV]
		[Availability (Deprecated = Platform.iOS_8_0 | Platform.Mac_10_10, Message = "Use Player")]
		[Export ("playerID", ArgumentSemantic.Copy)]
		string PlayerID { get;  }
	...
	interface GKGameCenterViewController
	{
		...
		[Availability (Deprecated = Platform.iOS_7_0 | Platform.Mac_10_10, Message = "This class no longer support Leaderboard Time Scopes, will always default to AllTime")]
