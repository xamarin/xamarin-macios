...
typedef void (*iterator_func) (enum IteratorAction action, void *context, const char *type, size_t size, void *target);
typedef void (*marshal_return_value_func) (void *context, const char *type, size_t size, void *value, MonoType *mtype, bool retain, MonoMethod *method);
