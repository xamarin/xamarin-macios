...
namespace Mono.Linker
{
	public readonly struct MessageContainer : IComparable<MessageContainer>, IEquatable<MessageContainer>
	{
		...
		internal static MessageContainer CreateErrorMessage (string text, int code, string subcategory = "", MessageOrigin? origin = null)
		{
		...
		public static MessageContainer CreateCustomErrorMessage (string text, int code, string subcategory = "", MessageOrigin? origin = null)
		{
#if DEBUG
		...
		private MessageContainer (MessageCategory category, string text, int? code, string subcategory = "", MessageOrigin? origin = null)
		{
			Code = code;
			Category = category;
			Origin = origin;
		...
		{
			const string originApp = "CustomStepHost";
