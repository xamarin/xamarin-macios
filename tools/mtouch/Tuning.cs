	...
	static partial class Linker {
		...
		static ResolveFromXmlStep GetResolveStep (string filename)
		{
			...
			if (!File.Exists (filename))
				throw new MonoTouchException (2004, true, Xamarin.Bundler.Errors.MT2004, filename);
			...
			try {
				...
				throw new MonoTouchException (2005, true, e, Xamarin.Bundler.Errors.MT2005, filename);
			}
		}
	}
	...
	public class CustomizeIOSActions : CustomizeActions
	{
		...
		protected override void ProcessAssembly (AssemblyDefinition assembly)
		{
			...
			try {
				...
				throw new MonoTouchException (2103, true, e, Xamarin.Bundler.Errors.MT2103, assembly.FullName, e);
			}
		}
	}
}
