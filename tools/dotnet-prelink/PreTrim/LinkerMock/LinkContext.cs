...
namespace Mono.Linker {
	...
	public partial class LinkContext : IMetadataResolver, ITryResolveMetadata {
		...
		public partial AssemblyDefinition? Resolve (AssemblyNameReference name)
		{
		...
		public partial bool TryGetCustomData (string key, out string? value)
		{
