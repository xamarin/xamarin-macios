...
#pragma warning restore RS0030 // Do not used banned APIs
			...
			if (method.HasGenericParameters) {
				TypeReferenceExtensions2.PrependGenericParameters (method.GenericParameters, sb);
			}
...
#pragma warning disable RS0030 // MethodReference.Parameters is banned -- it's best to leave this as is for now
			...
			return TypeReferenceExtensions2.InflateGenericType (genericInstance, method.Parameters[parameterIndex].ParameterType);
#pragma warning restore RS0030 // Do not used banned APIs
		}
