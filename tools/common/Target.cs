...
namespace Xamarin.Bundler {
	public partial class Target {
		...
		public void GatherFrameworks ()
		{
			...
			if (asm == null)
				throw ErrorHelper.CreateError (163, mtouch.mtouchErrors.MT0163, Driver.GetProductAssembly (App));
		...
		bool IsRequiredSymbol (Symbol symbol, Assembly single_assembly = null)
		{
			...
			default:
				throw ErrorHelper.CreateError (164, mtouch.mtouchErrors.MT0164, symbol.Type, symbol.Name);
			}
		}
