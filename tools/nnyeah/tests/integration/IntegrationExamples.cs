...
namespace Microsoft.MaciOS.Nnyeah.Tests.Integration {
	...
	public class IntegrationExamples {
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.ffimageloading.forms/2.4.11.982/xamarin.ffimageloading.forms.2.4.11.982.nupkg", "lib/Xamarin.iOS10/FFImageLoading.Forms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.ffimageloading.forms/2.4.11.982/xamarin.ffimageloading.forms.2.4.11.982.nupkg", "lib/Xamarin.Mac20/FFImageLoading.Forms.dll", ApplePlatform.MacOSX)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/carouselview.formsplugin/6.0.0/carouselview.formsplugin.6.0.0.nupkg", "lib/Xamarin.iOS10/CarouselView.FormsPlugin.Abstractions.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/zxing.net.mobile.forms/2.4.1/zxing.net.mobile.forms.2.4.1.nupkg", "lib/Xamarin.iOS10/ZXing.Net.Mobile.Forms.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xlabs.forms/2.0.5782/xlabs.forms.2.0.5782.nupkg", "lib/Xamarin.iOS10/XLabs.Forms.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.ffimageloading.svg.forms/2.4.11.982/xamarin.ffimageloading.svg.forms.2.4.11.982.nupkg", "lib/Xamarin.iOS10/FFImageLoading.Svg.Forms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.ffimageloading.svg.forms/2.4.11.982/xamarin.ffimageloading.svg.forms.2.4.11.982.nupkg", "lib/Xamarin.Mac20/FFImageLoading.Svg.Forms.dll", ApplePlatform.MacOSX)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/com.airbnb.xamarin.forms.lottie/4.1.0/com.airbnb.xamarin.forms.lottie.4.1.0.nupkg", "lib/xamarinios10/Lottie.Forms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/com.airbnb.xamarin.forms.lottie/4.1.0/com.airbnb.xamarin.forms.lottie.4.1.0.nupkg", "lib/xamarinmac20/Lottie.Forms.dll", ApplePlatform.MacOSX)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xam.plugins.forms.imagecircle/3.0.0.5/xam.plugins.forms.imagecircle.3.0.0.5.nupkg", "lib/xamarinios10/ImageCircle.Forms.Plugin.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/prism.dryioc.forms/8.1.97/prism.dryioc.forms.8.1.97.nupkg", "lib/xamarinios10/Prism.DryIoc.Forms.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/formstoolkit/2.0.1/formstoolkit.2.0.1.nupkg", "lib/Xamarin.iOS10/FormsToolkit.iOS.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.forms.pancakeview/2.3.0.759/xamarin.forms.pancakeview.2.3.0.759.nupkg", "lib/xamarinios10/Xamarin.Forms.PancakeView.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.forms.pancakeview/2.3.0.759/xamarin.forms.pancakeview.2.3.0.759.nupkg", "lib/xamarinmac20/Xamarin.Forms.PancakeView.dll", ApplePlatform.MacOSX)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/toasts.forms.plugin/3.3.2/toasts.forms.plugin.3.3.2.nupkg", "lib/Xamarin.iOS10/Toasts.Forms.Plugin.Abstractions.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/refractored.xamforms.pulltorefresh/2.4.1/refractored.xamforms.pulltorefresh.2.4.1.nupkg", "lib/xamarinios10/Refractored.XamForms.PullToRefresh.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/mvvmcross.forms/8.0.2/mvvmcross.forms.8.0.2.nupkg", "lib/xamarinios10/MvvmCross.Forms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/mvvmcross.forms/8.0.2/mvvmcross.forms.8.0.2.nupkg", "lib/xamarinmac20/MvvmCross.Forms.dll", ApplePlatform.MacOSX)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xamarin.forms.inputkit/3.7.2/xamarin.forms.inputkit.3.7.2.nupkg", "lib/xamarinios10/Plugin.InputKit.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/segmentedcontrol.formsplugin/2.0.1/segmentedcontrol.formsplugin.2.0.1.nupkg", "lib/portable-net45%2Bnetcore45%2Bwpa81%2Bwp8%2BMonoAndroid10%2BXamarin.iOS10/SegmentedControl.FormsPlugin.Abstractions.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xam.plugin.htmllabel/5.0.0/xam.plugin.htmllabel.5.0.0.nupkg", "lib/xamarinios10/HtmlLabel.Forms.Plugin.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/forms9patch/2.4.9/forms9patch.2.4.9.nupkg", "lib/Xamarin.iOS10/P42.Utils.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/xam.plugins.forms.keyboardoverlap/1.0.0.4/xam.plugins.forms.keyboardoverlap.1.0.0.4.nupkg", "lib/Xamarin.iOS10/KeyboardOverlap.Forms.Plugin.iOSUnified.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/uiatoms.xamarin.forms/2.1.420/uiatoms.xamarin.forms.2.1.420.nupkg", "lib/Xamarin.iOS10/NeuroSpeech.UIAtoms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/plugin.mediamanager.forms/1.1.1/plugin.mediamanager.forms.1.1.1.nupkg", "lib/xamarinios10/MediaManager.Forms.dll", ApplePlatform.iOS)]
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/plugin.mediamanager.forms/1.1.1/plugin.mediamanager.forms.1.1.1.nupkg", "lib/xamarinmac20/MediaManager.Forms.dll", ApplePlatform.MacOSX)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/oxyplot.xamarin.forms/1.0.0/oxyplot.xamarin.forms.1.0.0.nupkg", "lib/Xamarin.iOS10/OxyPlot.Xamarin.Forms.Platform.iOS.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/octane.xam.videoplayer/3.1.0/octane.xam.videoplayer.3.1.0.nupkg", "lib/Xamarin.iOS10/Octane.Xamarin.Forms.VideoPlayer.iOS.dll", ApplePlatform.iOS)]
		...
		// [TestCase ("https://api.nuget.org/v3-flatcontainer/aiforms.settingsview/1.3.31/aiforms.settingsview.1.3.31.nupkg", "lib/Xamarin.iOS10/SettingsView.dll", ApplePlatform.iOS)]
