...
dotnet format whitespace --folder "$SRC_DIR/src/BackgroundAssets"
dotnet format whitespace --folder "$SRC_DIR/src/CoreSpotlight"
dotnet format whitespace --folder "$SRC_DIR/src/MetalPerformanceShadersGraph"
dotnet format whitespace --folder "$SRC_DIR/src/MetricKit"
dotnet format whitespace --folder "$SRC_DIR/src/NativeTypes"
dotnet format whitespace --folder "$SRC_DIR/src/ObjCRuntime"
dotnet format whitespace --folder "$SRC_DIR/src/OpenGLES"
dotnet format whitespace --folder "$SRC_DIR/src/SharedWithYouCore"
dotnet format whitespace --folder "$SRC_DIR/src/Simd"
dotnet format whitespace --folder "$SRC_DIR/src/System.ComponentModel"
dotnet format whitespace --folder "$SRC_DIR/src/System.Drawing"
dotnet format whitespace --folder "$SRC_DIR/src/System.Net.Http"
dotnet format whitespace --folder "$SRC_DIR/src/VideoSubscriberAccount"
dotnet format whitespace --folder "$SRC_DIR/src/XKit"
