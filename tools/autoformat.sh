...
dotnet format whitespace "$SRC_DIR/tests/common/MonoTouch.Dialog/MonoTouch.Dialog.dotnet.csproj"
dotnet format whitespace "$SRC_DIR/tests/common/Touch.Unit/Touch.Client/Touch.Client.dotnet.csproj"
