...
namespace Cecil.Tests {
	public partial class ConstructorTest {
		...
		static HashSet<string> knownFailuresCtorsWithOutNSErrorParameter = new HashSet<string> {
			...
			"Foundation.NSAttributedString::.ctor(Foundation.NSData,Foundation.NSAttributedStringDocumentAttributes,Foundation.NSDictionary&,Foundation.NSError&)",
			...
			"Foundation.NSAttributedString::.ctor(Foundation.NSUrl,Foundation.NSAttributedStringDocumentAttributes,Foundation.NSDictionary&,Foundation.NSError&)",
