...
namespace MonoTouchFixtures.GameKit {
	...
	public class GKGameCenterViewControllerTest {
		...
		{
			TestRuntime.AssertXcodeVersion (12, 0);
			using var controller = new GKGameCenterViewController ("achievementId", GKGameCenterViewControllerInitializationOption.AchievementId);
			Assert.AreEqual (controller.ViewState, GKGameCenterViewControllerState.Achievements, "ViewState");
		}
		...
		public void StringOptionCtor_LeaderboardSetId ()
		{
			...
			using var controller = new GKGameCenterViewController ("achievementId", GKGameCenterViewControllerInitializationOption.LeaderboardSetId);
