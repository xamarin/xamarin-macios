...
namespace MonoTouchFixtures.ObjCRuntime {
	...
	public class DisposableObjectTest {
		...
		public void CtorOwns ()
		{
			...
			obj = new Subclassed ((NativeHandle) 1, true);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 3");
			Assert.AreEqual (true, obj.Owns, "Owns 3");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 3");
			obj.Dispose ();
			...
			obj = new Subclassed ((NativeHandle) 1, false);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 4");
			Assert.AreEqual (false, obj.Owns, "Owns 4");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 4");
			obj.Dispose ();
		...
		public void CtorOwnsVerify ()
		{
			...
			obj = new Subclassed ((NativeHandle) 1, true, false);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 3");
			Assert.AreEqual (true, obj.Owns, "Owns 3");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 3");
			obj.Dispose ();
			...
			obj = new Subclassed ((NativeHandle) 1, false, false);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 4");
			Assert.AreEqual (false, obj.Owns, "Owns 4");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 4");
			...
			obj = new Subclassed ((NativeHandle) 1, true, true);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 3V");
			Assert.AreEqual (true, obj.Owns, "Owns 3V");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 3V");
			obj.Dispose ();
			...
			obj = new Subclassed ((NativeHandle) 1, false, true);
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "Handle 4V");
			Assert.AreEqual (false, obj.Owns, "Owns 4V");
			Assert.AreEqual ((NativeHandle) 1, obj.GetCheckedHandle (), "GetCheckedHandle 4V");
			obj.Dispose ();
		...
		public void Handle ()
		{
			...
			obj.Handle = (NativeHandle) 1;
			Assert.AreEqual ((NativeHandle) 1, obj.Handle, "GetHandle");
		}
	}
}
