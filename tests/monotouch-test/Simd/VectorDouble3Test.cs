...
namespace MonoTouchFixtures.Simd {
	...
	public class VectorDouble3Test {

		[Test]
		public void ElementConstructor ()
		{
			var expected = GetTestVector ();
			var actual = new VectorDouble3 (expected.X, expected.Y, expected.Z);
		...
		public void Equality_Operator ()
		{
			...
			var inputSimdL = (VectorDouble3) inputL;
			var inputSimdR = (VectorDouble3) inputR;
		...
		public void Explicit_Operator_FromVector3 ()
		{
			...
			var actual = (VectorDouble3) expected;
		...
		{
			var vector = new VectorDouble3 (1, 2, 3);
		...
		public void Equals_Object ()
		{
			...
			var actualA = (VectorDouble3) expectedA;
			var actualB = (VectorDouble3) expectedB;
		...
		static VectorDouble3 [] test_vectors = new [] {
			new VectorDouble3 (0.1532144d, 0.5451511d, 0.2004739d),
			new VectorDouble3 (0.7717745d, 0.559364d, 0.00918373d),
			new VectorDouble3 (0.2023053d, 0.4701468d, 0.6618567d),
			new VectorDouble3 (0.4904693d, 0.841727d, 0.2294401d),
			new VectorDouble3 (0.1252193d, 0.08986127d, 0.3407605d),
			new VectorDouble3 (0.006755914d, 0.07464754d, 0.287938d),
			new VectorDouble3 (9.799572E+08d, 1.64794E+09d, 1.117296E+09d),
			new VectorDouble3 (1.102396E+09d, 3.082477E+08d, 1.126484E+09d),
			new VectorDouble3 (2.263112E+08d, 8.79644E+08d, 1.303282E+09d),
			new VectorDouble3 (8.176959E+08d, 1.386156E+09d, 5.956444E+08d),
		};

		static int counter;
		internal static VectorDouble3 GetTestVector ()
		{
			counter++;
