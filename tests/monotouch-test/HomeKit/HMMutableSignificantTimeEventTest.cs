...
namespace MonoTouchFixtures.HomeKit
{
	...
	public class HMMutableSignificantTimeEventTest
	{
		...
		public void Setup ()
		{
			...
			// Mac Catalyst system versions follow the macOS system versions, and HomeKit was introduced to Mac Catalyst later than for the other frameworks, so we have this additional check
