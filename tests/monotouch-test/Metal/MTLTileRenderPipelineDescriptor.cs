...
namespace MonoTouchFixtures.Metal {
	...
	public class MTLTileRenderPipelineDescriptorTests {
		...
		public void SetUp ()
		{
			...
			// Mac Catalyst system versions follow the macOS system versions, and MTLTileRenderPipelineDescriptor was introduced to Mac Catalyst later than for the other frameworks, so we have this additional check
