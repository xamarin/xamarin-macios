...
namespace Xamarin.iOS.UnitTests {
	...
	public static class RegisterType
	{
		...
		public static Dictionary <string, Type> TypesToRegister = new Dictionary <string, Type> {
			{ "monotouch_tv_System.Numerics_xunit-test.dll", typeof (System.Numerics.Tests.GenericVectorTests)}, 
			{ "monotouch_tv_System.Core_xunit-test.dll", typeof (System.Security.Cryptography.Algorithms.Tests.IncrementalHashTests)}, 
			{ "monotouch_tv_System_xunit-test.dll", typeof (System.Text.RegularExpressionsTests.PrecompiledRegexScenarioTest)}, 
			{ "monotouch_tv_Microsoft.CSharp_xunit-test.dll", typeof (Microsoft.CSharp.RuntimeBinder.Tests.AccessTests)}, 
