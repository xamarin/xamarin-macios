...
namespace Xamarin.iOS.UnitTests {
	...
	public static class RegisterType
	{
		...
		public static Dictionary <string, Type> TypesToRegister = new Dictionary <string, Type> {
			{ "monotouch_tv_System.Data_xunit-test.dll", typeof (System.Data.SqlClient.Tests.CloneTests)}, 
			{ "monotouch_tv_System.Json_xunit-test.dll", typeof (System.Json.Tests.JsonArrayTests)}, 
			{ "monotouch_tv_System.Security_xunit-test.dll", typeof (System.Security.Cryptography.ProtectedDataTests.ProtectedDataTests)}, 
			{ "monotouch_tv_System.Xml.Linq_xunit-test.dll", typeof (XLinqTests.TreeManipulationTests)}, 
			{ "monotouch_tv_System.Xml_xunit-test.dll", typeof (System.Xml.Tests.AppendTests)}, 
			{ "monotouch_tv_System.Runtime.CompilerServices.Unsafe_xunit-test.dll", typeof (System.Runtime.CompilerServices.UnsafeTests)}, 
