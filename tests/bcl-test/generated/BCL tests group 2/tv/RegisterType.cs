...
namespace Xamarin.iOS.UnitTests {
	...
	public static class RegisterType
	{
		...
		public static Dictionary <string, Type> TypesToRegister = new Dictionary <string, Type> {
			{ "monotouch_tv_System_test.dll", typeof (MonoTests.System.FileStyleUriParserTest)}, 
			{ "monotouch_tv_System.Data_test.dll", typeof (Monotests_Mono.Data.SqlExpressions.DataColumnExprTest)}, 
			{ "monotouch_tv_System.Net.Http_test.dll", typeof (MonoTests.System.Net.Http.ByteArrayContentTest)}, 
			{ "monotouch_tv_Mono.Data.Tds_test.dll", typeof (MonoTests.Mono.Data.Tds.TdsConnectionPoolTest)}, 
			{ "monotouch_tv_System.ServiceModel_test.dll", typeof (MonoTests.System.ServiceModel.FaultExceptionTest)}, 
			{ "monotouch_tv_corlib_test.dll", typeof (MonoTests.System.ActivatorTest)}, 
			{ "monotouch_tv_System.Web.Services_test.dll", typeof (MonoTests.System.Web.Services.WebMethodAttributeTest)}, 
