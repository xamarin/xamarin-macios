...
namespace Xharness.Tests.Listeners.Tests {
	...
	public class SimpleListenerFactoryTest {
		...
		{
			var transport = factory.Create (RunMode.iOS, log.Object, true, out var listener, out var listenerFileTemp);
		...
		public void CreateWatchOSSimulator ()
		{
			...
			var transport = factory.Create (RunMode.WatchOS, log.Object, true, out var listener, out var listenerFileTemp);
		...
		{
			var transport = factory.Create (RunMode.WatchOS, log.Object, false, out var listener, out var listenerFileTemp);
