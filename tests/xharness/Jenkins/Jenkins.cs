...
namespace Xharness.Jenkins
{
	public class Jenkins
	{
		...
		Task BuildTestLibrariesAsync ()
		{
			...
			return Harness.ProcessManager.ExecuteCommandAsync ("make", new [] { "all", "-j2", "-C", Path.Combine (Harness.RootDirectory, "test-libraries"), "V=1" }, log, TimeSpan.FromMinutes (10)).ContinueWith ((v) => {
				var per = v.Result;
