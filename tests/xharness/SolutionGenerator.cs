...
namespace Xharness
{
	public static class SolutionGenerator
	{
		...
		public static void CreateSolution (Harness harness, IEnumerable<Target> targets, Target exeTarget, string infix)
		{
			...
			var sln_path = exeTarget == null ? Path.Combine (DirectoryUtilities.RootDirectory, "tests-" + infix + ".sln") : Path.Combine (Path.GetDirectoryName (exeTarget.ProjectPath), Path.GetFileNameWithoutExtension (exeTarget.ProjectPath) + ".sln");
