...
namespace Xharness {
	...
	public class Harness : IHarness {
		...
		{
			var test_suites = new string [] { "monotouch-test", "xcframework-test" };
			var library_projects = new string [] { "BundledResources", "EmbeddedResources", "bindings-test2", "bindings-xcframework-test" };
