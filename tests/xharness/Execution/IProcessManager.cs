...
namespace Xharness.Execution {
	...
	public interface IProcessManager {
		...
		Task<ProcessExecutionResult> RunAsync (Process process, ILog log, CancellationToken? cancellation_token = null, bool? diagnostics = null);
		...
		Task KillTreeAsync (Process @this, ILog log, bool? diagnostics = true);
